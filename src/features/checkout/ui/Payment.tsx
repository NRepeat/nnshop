...
import PaymentForm from '@entities/payment/ui/PaymentForm';
import { getPaymentInfo } from '@entities/payment/api/getPaymentInfo';
import { generateOrderId } from '@entities/payment/api/generateOrderId';
...
export default async function Payment() {
  ...
  // Get cart data and calculate total amount
  let cartAmount = 0;
  let currency = 'USD';
  try {
