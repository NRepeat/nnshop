...
export type PredictiveSearchQuery = { predictiveSearch?: StorefrontTypes.Maybe<{ products: Array<(
      ...
      & { featuredImage?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url'>>, metafields: Array<StorefrontTypes.Maybe<Pick<StorefrontTypes.Metafield, 'key' | 'value'>>>, priceRange: { maxVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, variants: { edges: Array<{ node: { price: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> } }> } }
    )> }> };

export type GetAllProductsForSitemapQueryVariables = StorefrontTypes.Exact<{
  first: StorefrontTypes.Scalars['Int']['input'];
  after?: StorefrontTypes.InputMaybe<StorefrontTypes.Scalars['String']['input']>;
}>;


export type GetAllProductsForSitemapQuery = { products: { edges: Array<{ node: Pick<StorefrontTypes.Product, 'handle' | 'updatedAt'> }>, pageInfo: Pick<StorefrontTypes.PageInfo, 'hasNextPage' | 'endCursor'> } };

export type GetAllCollectionsForSitemapQueryVariables = StorefrontTypes.Exact<{ [key: string]: never; }>;


export type GetAllCollectionsForSitemapQuery = { collections: { edges: Array<{ node: Pick<StorefrontTypes.Collection, 'handle' | 'updatedAt'> }> } };
...
export type GetCartQuery = { cart?: StorefrontTypes.Maybe<(
    ...
    & { cost: { totalAmount: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, subtotalAmount: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, lines: { edges: Array<{ node: (
          ...
          ), cost: { totalAmount: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, amountPerQuantity: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, attributes: Array<Pick<StorefrontTypes.Attribute, 'key' | 'value'>> }
        ) | (
        ...
        ) }> }, attributes: Array<Pick<StorefrontTypes.Attribute, 'key' | 'value'>>, discountCodes: Array<Pick<StorefrontTypes.CartDiscountCode, 'code' | 'applicable'>>, delivery: { addresses: Array<(
...
export type GetCollectionQuery = { collection?: StorefrontTypes.Maybe<(
    ...
    & { image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText'>>, products: { pageInfo: Pick<StorefrontTypes.PageInfo, 'hasNextPage' | 'hasPreviousPage' | 'endCursor' | 'startCursor'>, edges: Array<{ node: (
...
export type GetProductByHandleQuery = { product?: StorefrontTypes.Maybe<(
    ...
    & { priceRange: { maxVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, options: Array<Pick<StorefrontTypes.ProductOption, 'id' | 'name' | 'values'>>, variants: { edges: Array<{ node: (
          Pick<StorefrontTypes.ProductVariant, 'id' | 'title' | 'availableForSale' | 'sku'>
...
interface GeneratedQueryTypes {
  ...
  "#graphql\n  query GetAllProductsForSitemap($first: Int!, $after: String) {\n    products(first: $first, after: $after) {\n      edges {\n        node {\n          handle\n          updatedAt\n        }\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n": {return: GetAllProductsForSitemapQuery, variables: GetAllProductsForSitemapQueryVariables},
  "#graphql\n  query GetAllCollectionsForSitemap {\n    collections(first: 250) {\n      edges {\n        node {\n          handle\n          updatedAt\n        }\n      }\n    }\n  }\n": {return: GetAllCollectionsForSitemapQuery, variables: GetAllCollectionsForSitemapQueryVariables},
