...
export type ResolveLinkQuery = { collection?: StorefrontTypes.Maybe<(
...
interface GeneratedQueryTypes {
  ...
  "#graphql\n      query ResolveLink($id: ID!) @inContext(language: RU) { collection(id: $id) { handle ,title,image{url} } }": {return: ResolveLinkQuery, variables: ResolveLinkQueryVariables},
}
