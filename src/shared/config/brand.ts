...
export const INSTAGRAM_URL = process.env.NEXT_PUBLIC_INSTAGRAM_URL ?? 'https://instagram.com/miomio.ua';
export const FACEBOOK_URL = process.env.NEXT_PUBLIC_FACEBOOK_URL ?? 'https://facebook.com/miomio.ua';
