...
export const ViberIcon = ({ collor = '#ffffff' }: { collor?: string }) => (
  <svg
  ...
  }> = [
    {
      ...
      url:
        footer?.socialLinks?.find(
          (l: { platform?: string | null }) => l.platform === 'facebook',
        )?.url ?? FACEBOOK_URL,
      icon: <FacebookIcon />,
    },
    {
      ...
      url:
        footer?.socialLinks?.find(
          (l: { platform?: string | null }) => l.platform === 'instagram',
        )?.url ?? INSTAGRAM_URL,
      icon: <InstagramIcon />,
    },
  ];
              ...
              <div className="flex items-start gap-2 text-white/60 text-sm">
                ...
                <div className="flex flex-col gap-0.5">
                  <a
                    ...
                    className="inline-flex items-center min-h-6 hover:text-white transition-colors"
                  >
                    {phone1}
                  </a>
                  <a
